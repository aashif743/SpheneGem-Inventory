    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Box sx={{ 
          ...
          <Box sx={{ display: view === 'dashboard' ? 'block' : 'none' }}><Dashboard /></Box>
          <Box sx={{ display: view === 'stock' ? 'block' : 'none' }}><GemstoneTable /></Box>
          <Box sx={{ display: view === 'add' ? 'block' : 'none' }}><AddGemstoneForm /></Box>
          <Box sx={{ display: view === 'sales' ? 'block' : 'none' }}><SalesTable /></Box>
        </Box>
      </Box>
    </Box>
  );
